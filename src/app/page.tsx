    ...
    <main className="min-h-screen gradient-hero relative overflow-hidden">
      ...
      <nav className="relative z-10 px-6 py-6 md:px-12">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold gradient-text">Nishara</span>
          </div>
      ...
      <section className="relative z-10 px-6 pt-16 pb-32 md:pt-24 md:pb-40 lg:pt-32 lg:pb-48">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="animate-fade-in-up inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8">
            ...
            <span className="text-sm text-pink-200">Women-Only Travel Safety App — Coming Soon</span>
          </div>
          ...
          {/* Tagline */}
          <p className="animate-fade-in-up delay-150 text-xl md:text-2xl text-rose-300 font-medium mb-4">
            Travel freely. Travel safely. Travel together.
          </p>

          {/* Subheadline */}
          <p className="animate-fade-in-up delay-200 text-lg md:text-xl text-pink-200 max-w-2xl mx-auto mb-12 leading-relaxed">
          ...
          <div className="animate-fade-in-up delay-300 flex flex-col items-center gap-3">
            ...
            <p className="text-pink-300 text-sm italic">Help us build Nishara for YOU — your input shapes our features</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-12 animate-fade-in-up delay-500">
            ...
            <p className="text-pink-200">
              <span className="text-white font-semibold">Over 2,500</span> women already joined the sisterhood
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="relative z-10 px-6 py-24 md:py-32 mt-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-pink-200 max-w-xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-pink-500/20 to-rose-500/20 flex items-center justify-center mb-6 text-pink-300 group-hover:text-rose-400 transition-colors">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold text-white mb-3">{feature.title}</h3>
                <p className="text-pink-200 leading-relaxed">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative z-10 px-6 py-24 md:py-32">
        <div className="max-w-4xl mx-auto">
          <div className="glass-card rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            {/* Decorative Elements */}
            <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-pink-500/20 to-transparent rounded-full -translate-x-1/2 -translate-y-1/2" />
            <div className="absolute bottom-0 right-0 w-40 h-40 bg-gradient-to-tl from-rose-500/20 to-transparent rounded-full translate-x-1/2 translate-y-1/2" />

            <div className="relative z-10">
              <div className="flex justify-center mb-6">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg key={star} className="w-6 h-6 text-rose-400" fill="currentColor" viewBox="0 0 20 20">
              ...
              <blockquote className="text-xl md:text-2xl text-white font-medium mb-6 leading-relaxed">
                &ldquo;I traveled solo across three states last month. Having Nishara's verified
                safe spots and the Local Birds community gave me the confidence to explore
                places I never would have dared before. This is what women travelers needed.&rdquo;
              </blockquote>
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-pink-300 text-sm">Beta Tester & Solo Traveler</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="about" className="relative z-10 px-6 py-24 md:py-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-pink-200 text-lg mb-8 max-w-xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold gradient-text">Nishara</span>
            </div>
